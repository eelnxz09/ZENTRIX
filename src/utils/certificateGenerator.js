...
// Pure CSS replacement for the ZK Logo to completely eliminate image loading crashes
const cssLogo = `
  <div style="width:140px;height:140px;display:inline-flex;align-items:center;justify-content:center;background:linear-gradient(135deg, #FF2D78, #FF4655);box-shadow:0 0 30px rgba(255,45,120,0.6);border-radius:24px;transform:rotate(-10deg);margin-bottom:30px; border: 4px solid #FFF;">
      <span style="font-family:'Orbitron',monospace;color:#FFF;font-size:60px;font-weight:900;letter-spacing:-6px;font-style:italic;">ZK</span>
  </div>
`;

// Utility component generating exact HTML for 10 different styles
export const TEMPLATES = {
  ...
  participation: (data) => `
    <div style="width:1920px;height:1080px;background:#FAFAFA;color:#111;display:flex;flex-direction:column;align-items:center;justify-content:center;font-family:'Outfit',sans-serif;position:relative;border:1px solid #E5E7EB;overflow:hidden;">
        ...
        <div style="z-index:2;">${cssLogo}</div>
  ...
  rookie: (data) => `
    <div style="width:1920px;height:1080px;background:#0ea5e9;color:#fff;display:flex;flex-direction:column;align-items:flex-start;justify-content:center;padding:120px;font-family:'Outfit',sans-serif;position:relative;overflow:hidden;">
        ...
        <div style="position:absolute;bottom:100px;right:100px;z-index:2;">
            ${cssLogo}
        </div>
    </div>`,
  clutch: (data) => `
